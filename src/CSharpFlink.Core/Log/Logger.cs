...
namespace CSharpFlink.Core.Log
{
    ...
    public class Logger : ILogger
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Log.Logger"/> class.
        /// </summary>
        /// <param name="name">The name.</param>
        /// <param name="logContainer">The Show Container.</param>
        public Logger(string name, ILogContainer logContainer = null)
        {
            m_Name = name;
            ...
            get
            {
                if(_Log == null)
                {
                    lock(LockObj)
                    {
                        if(_Log == null)
                        {
                            _Log = (new LogFactory()).GetLog("CSharpFlink", new ConsoleContainer());
                        }
                    }
                }
                return _Log;
